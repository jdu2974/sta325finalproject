...
wtf <- boosting_nf_train[, sapply(boosting_nf_train, class) == 'character']


bst <- xgboost(data = as.matrix(boosting_nf_train), label = boosting_nf_train$play_type, max_depth = 2, 
